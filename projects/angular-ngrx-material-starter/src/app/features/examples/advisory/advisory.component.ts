...
export class AdvisoryComponent implements OnInit {
  ...
  rowSpecialOrder(){
    this.recordService.getAllDocumentType('Advisory').subscribe(data => {
      console.log(data);
      this.rowData = data;
  ...
  constructor(
    ...
    this.autoGroupColumnDef = {
      headerName: 'Year - Month / Advisory #',
      minWidth: 350,
      pinned: 'left',
      field: 'code',
      cellRendererParams: {
  ...
  openDialog() {
    this.dialog.open(EntryDialogComponent, {
      minWidth: '50vh',
      data: { gridApi: this.gridApi, add: true, type:  'Advisory'}
    });
  }
  ...
  methodFromParentDelete(cell) {
    this.dialog.open(EntryDialogComponent, {
      minWidth: '50vh',
      data: { gridApi: this.gridApi, data: cell, delete: true,  type:  'Advisory' }
    });
  }
  ...
  methodFromParentEdit(cell) {
    this.dialog.open(EntryDialogComponent, {
      minWidth: '50vh',
      data: { gridApi: this.gridApi, data: cell, edit: true, type:  'Advisory' }
    });
  }
