...
@Component({
  selector: 'anms-travel-order',
  templateUrl: './travel-order.component.html',
  styleUrls: ['./travel-order.component.scss'],
...
export class TravelOrderComponent implements OnInit {
  ...
  rowTravelOrder(){
    this.recordService.getAllDocumentType('Travel Order').subscribe((data: any) => {
      console.log(data);
        this.rowData = data;
  ...
  constructor( 
    ...
    public dialog: MatDialog
      ...
      this.columnDefs = [
        ...
        {
          headerName: 'Travel Order Number',
          field: 'code',
          width: 250,
  ...
  methodFromParentDelete(cell) {
    this.dialog.open(EntryDialogComponent, {
      minWidth: '50vh',
      data: { gridApi: this.gridApi, data: cell, delete: true, type:  'Travel Order' }
    });
  }
  ...
  methodFromParentEdit(cell) {
    this.dialog.open(EntryDialogComponent, {
      minWidth: '50vh',
      data: { gridApi: this.gridApi, data: cell, edit: true, type:  'Travel Order' }
    });
  }
