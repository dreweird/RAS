...
export class SpecialOrderComponent implements OnInit {
  ...
  rowSpecialOrder(){
    this.recordService.getAllDocumentType('Special Order').subscribe(data => {
      console.log(data);
      this.rowData = data;
  ...
  constructor(
    ...
    this.columnDefs = [
      ...
      {
        headerName: 'Special Order Number',
        field: 'code',
        width: 250,
        hide: true,
  ...
  openDialog() {
    this.dialog.open(EntryDialogComponent, {
      minWidth: '50vh',
      data: { gridApi: this.gridApi, add: true, type:  'Special Order'}
    });
  }
  ...
  methodFromParentDelete(cell) {
    this.dialog.open(EntryDialogComponent, {
      minWidth: '50vh',
      data: { gridApi: this.gridApi, data: cell, delete: true,  type:  'Special Order' }
    });
  }
  ...
  methodFromParentEdit(cell) {
    this.dialog.open(EntryDialogComponent, {
      minWidth: '50vh',
      data: { gridApi: this.gridApi, data: cell, edit: true, type:  'Special Order' }
    });
  }
